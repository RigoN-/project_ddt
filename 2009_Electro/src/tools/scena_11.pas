...
procedure load_texture_scena_11();
procedure ogl_on_start_scena_11(width,height:glInt);
procedure key_pressed_scena_11( keysym : PSDL_keysym );
procedure mouse_button_pressed_scena_11 ( button : TSDL_MouseButtonEvent );
procedure mouse_motion_scena_11( motion :  TSDL_MouseMotionEvent );
procedure fon_draw_scena_11();
procedure  shema_draw_scena_11(on_off: GLInt; begunok: glFloat);
...
procedure load_texture_scena_11();
begin
	OGL_Load_Texture(PATH_TEXTURE+'op11_ris1.bmp', Zadniy_fon_01, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture(PATH_TEXTURE+'opisanie_op_11.bmp', Zadniy_fon_02, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
end;
//////////////////////////////////////////////////////////////////////////////////////
procedure ogl_on_start_scena_11(width,height:glInt);
begin
