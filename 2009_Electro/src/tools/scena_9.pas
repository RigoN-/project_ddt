...
procedure load_texture_scena_9();
procedure ogl_on_start_scena_9(width,height:glInt);
procedure key_pressed_scena_9( keysym : PSDL_keysym );
procedure mouse_button_pressed_scena_9 ( button : TSDL_MouseButtonEvent );
procedure mouse_motion_scena_9( motion :  TSDL_MouseMotionEvent );
procedure fon_draw_scena_9();
procedure  shema_draw_scena_9(on_off: GLInt);
...
procedure load_texture_scena_9();
begin
	OGL_Load_Texture(PATH_TEXTURE+'op9_ris1.bmp', Zadniy_fon_01, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture(PATH_TEXTURE+'op9_ris2.bmp', Zadniy_fon_03, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture(PATH_TEXTURE+'op9_ris3.bmp', Zadniy_fon_04, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture(PATH_TEXTURE+'opisanie_op_9.bmp', Zadniy_fon_02, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
