...
procedure load_texture_scena_3();
procedure ogl_on_start_scena_3(width,height:glInt);
procedure key_pressed_scena_3( keysym : PSDL_keysym );
procedure mouse_button_pressed_scena_3 ( button : TSDL_MouseButtonEvent );
procedure mouse_motion_scena_3( motion :  TSDL_MouseMotionEvent );
procedure fon_draw_scena_3();
procedure  shema_draw_scena_3(on_off: GLInt);
...
procedure load_texture_scena_3();
begin
	OGL_Load_Texture(PATH_TEXTURE+'op3_ris1.bmp', Zadniy_fon_01, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture(PATH_TEXTURE+'opisanie_op_3.bmp', Zadniy_fon_02, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
end;
//////////////////////////////////////////////////////////////////////////////////////
procedure ogl_on_start_scena_3(width,height:glInt);
begin
