...
procedure load_texture_scena_6();
procedure ogl_on_start_scena_6(width,height:glInt);
procedure key_pressed_scena_6( keysym : PSDL_keysym );
procedure mouse_button_pressed_scena_6 ( button : TSDL_MouseButtonEvent );
procedure mouse_motion_scena_6( motion :  TSDL_MouseMotionEvent );
procedure fon_draw_scena_6();
procedure  shema_draw_scena_6(begunok: glFloat; on_off: GLInt);
...
procedure load_texture_scena_6();
begin
	OGL_Load_Texture(PATH_TEXTURE+'op6_ris1.bmp', Zadniy_fon_01, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture(PATH_TEXTURE+'opisanie_op_6.bmp', Zadniy_fon_02, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
end;
//////////////////////////////////////////////////////////////////////////////////////
procedure ogl_on_start_scena_6(width,height:glInt);
begin
