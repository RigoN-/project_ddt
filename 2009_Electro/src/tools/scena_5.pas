...
procedure load_texture_scena_5();
procedure ogl_on_start_scena_5(width,height:glInt);
procedure key_pressed_scena_5( keysym : PSDL_keysym );
procedure mouse_button_pressed_scena_5 ( button : TSDL_MouseButtonEvent );
procedure mouse_motion_scena_5( motion :  TSDL_MouseMotionEvent );
procedure  shema_draw_scena_5(begunok: glFloat; on_off: GLInt);
procedure fon_draw_scena_5();
procedure quads_draw_okno_1(size_x,size_y:GLFloat);
implementation
///////////////////////////////////////////////////////////////////////////////
procedure load_texture_scena_5();
begin
	OGL_Load_Texture(PATH_TEXTURE+'op5_ris1.bmp', Zadniy_fon_01, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture(PATH_TEXTURE+'opisanie_op_5.bmp', Zadniy_fon_02, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
end;
//////////////////////////////////////////////////////////////////////////////////////
procedure ogl_on_start_scena_5(width,height:glInt);
begin
...
begin
	...
	glTranslatef(-2.9,2.6,0.0);
	quads_draw_okno_1(4.0, 2.5);
	glPopMatrix();
	end;
	glColor4f(1.0,1.0,1.0,1.0);
