...
procedure load_texture_scena_10();
procedure ogl_on_start_scena_10(width,height:glInt);
procedure key_pressed_scena_10( keysym : PSDL_keysym );
procedure mouse_button_pressed_scena_10 ( button : TSDL_MouseButtonEvent );
procedure mouse_motion_scena_10( motion :  TSDL_MouseMotionEvent );
procedure fon_draw_scena_10();
procedure  shema_draw_scena_10(on_off: GLInt; begunok: glFloat);
...
procedure load_texture_scena_10();
begin
	OGL_Load_Texture(PATH_TEXTURE+'op10_ris1.bmp', Zadniy_fon_01, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture(PATH_TEXTURE+'opisanie_op_10.bmp', Zadniy_fon_02, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
end;
//////////////////////////////////////////////////////////////////////////////////////
procedure ogl_on_start_scena_10(width,height:glInt);
begin
...
begin
    ...
    glRotatef(povorot,0.0,1.0,0.0);
    	shema_17(on_off,begunok,0.19225,0.4,0.50873,51);
    glPopMatrix();
end;
...
begin
	...
	quads_draw_okno_1(2.5,1.4);
	glPopMatrix();
	
	glPushMatrix();	
	glBindTexture( GL_TEXTURE_2D, Zadniy_fon_02 );
	glTranslatef(-3.4,2.7,0.0);
	quads_draw_okno_1(3.5, 2.5);
	glPopMatrix();
	end;
	glColor4f(1.0,1.0,1.0,1.0);
