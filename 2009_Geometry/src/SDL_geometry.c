    ...
    #include <stdio.h>         // Подключение модуля std
    #include <stdlib.h>        // Подключение библиотеки std
    #include <GL/gl.h>         // Подключение библиотеки GL
    #include <GL/glu.h>        // подключение библиотеки GLU
    #include <SDL/SDL.h>       // Подключение мультимидийной библиотеки SDL
    #include <math.h>          // Подключение математического модуля
    #include "tools/texture.h" // Подключение модуля для загрузки текстур
...
GLvoid ogl_init(  )
{
	...
	OGL_Load_Texture("../data/textures/load.bmp", &load_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/load_0.bmp", &load_0_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/load_1.bmp", &load_1_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/load_2.bmp", &load_2_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/load_3.bmp", &load_3_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/load_4.bmp", &load_4_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/load_5.bmp", &load_5_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
}
...

{
	...
	SDL_Delay(1000 );
	OGL_Load_Texture("../data/textures/left.bmp", &tex_01, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/right.bmp", &tex_02, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena0/fon.bmp", &tex_26, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	splash_draw(load_tex, load_1_tex);
	SDL_Delay(1000 );
	OGL_Load_Texture("../data/textures/scena1/page1.1.bmp", &tex_13, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena2/page2.1.bmp", &tex_14, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena2/page3.1.bmp", &tex_15, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	splash_draw(load_tex, load_2_tex);
	SDL_Delay(1000 );
	OGL_Load_Texture("../data/textures/scena3/page4.1.bmp", &tex_16, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena3/page5.1.bmp", &tex_17, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena4/page6.1.bmp", &tex_23, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena4/page7.1.bmp", &tex_24, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	splash_draw(load_tex, load_3_tex);
	SDL_Delay(1000 );
	OGL_Load_Texture("../data/textures/scena5/page8.1.bmp", &tex_20, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena5/page9.1.bmp", &tex_21, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena5/page10.1.bmp", &tex_19, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	splash_draw(load_tex, load_4_tex);
	SDL_Delay(1000 );
	OGL_Load_Texture("../data/textures/scena5/page11.1.bmp", &tex_18, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
    OGL_Load_Texture("../data/textures/scena7/page12.1.bmp", &tex_22, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/scena8/oblojka_2_back.bmp", &tex_25, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/oblojka_1_face.bmp", &tex_obl_face_1, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/oblojka_1_back.bmp", &tex_obl_back, txBilinear, GL_MODULATE, GL_CLAMP, txNoCompressed,GL_TRUE);
	splash_draw(load_tex, load_5_tex);
	SDL_Delay(1000 );
	OGL_Load_Texture("../data/textures/torec.bmp", &tex_obl_torec_1, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/help_r.bmp", &help_r_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/help_l.bmp", &help_l_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
	OGL_Load_Texture("../data/textures/title.bmp", &title_tex, txBilinear, GL_MODULATE, GL_REPEAT, txNoCompressed,GL_TRUE);
}
